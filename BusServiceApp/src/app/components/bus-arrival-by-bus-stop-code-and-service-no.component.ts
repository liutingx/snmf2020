...
@Component({
  selector: 'app-bus-arrival-by-bus-stop-code-and-service-no',
  templateUrl: './bus-arrival-by-bus-stop-code.component.html',
  styleUrls: ['./bus-arrival-by-bus-stop-code.component.css']
})
export class BusArrivalByBusStopCodeAndServiceNoComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const serviceNo = parseInt(this.activatedRoute.snapshot.params['serviceNo'])
